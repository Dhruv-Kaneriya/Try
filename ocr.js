...
$("#btn-save").click( function() {
  ...
  var x = document.getElementById("fileformat").selectedIndex;
  var y = document.getElementById("fileformat").options;
  if(y[x].text=="Text File")
  {
  var blob = new Blob([text], {type: "text/plain;charset=utf-8"});
  saveAs(blob, filename+".txt");
  }
  else if(y[x].text=="PDF File") {
    var blob = new Blob([text], {type:"pdf/plain;charset=utf-8"});
